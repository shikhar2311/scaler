...
`;
    ...
    const fullPrompt = systemInstructions + problemInfo + conversationContext + "User: " + prompt;
...
app.get('/api/leetcode/problem/:slug', async (req, res) => {
  ...
  res.json({
    ...
    problem: {
      ...
      tags: ['Array', 'Dynamic Programming', 'Graph', 'Tree'].sort(() => 0.5 - Math.random()).slice(0, 2),
